...
export default class CustomLinkFormView extends LinkFormView {
  ...
  _createPlayInputs() {
    ...
    this.playExcerptInputView.bind('isOn').to(this, 'params', (params) => !!params?.excerpt)
    ...
    this.playStartInputView.fieldView.bind('value').to(this, 'params', (params) => params?.start)
    ...
    this.playEndInputView.fieldView.bind('value').to(this, 'params', (params) => params?.end)
    ...
    this.playScenarioInputView = new LabeledFieldView(locale, createLabeledDropdown)
    ...
    this.playScenarioInputView.bind('isEmpty').to(this, 'params', (params) => !params?.scenario)
    ...
    addListToDropdown(this.playScenarioInputView.fieldView, dropdownDefinitions)
    ...
    this.playHighlightInputView.bind('isOn').to(this, 'params', (params) => !!params?.highlight)
  ...
  _createSeekInputs() {
    ...
    this.seekTimeInputView.fieldView.bind('value').to(this, 'params', (params) => params?.time)
  ...
  _createPageInputs() {
    ...
    this.pageBlockInputView = new LabeledFieldView(locale, createLabeledDropdown)
    ...
    this.pageBlockInputView.bind('isEmpty').to(this, 'params', (params) => !params?.block)
    ...
    // Index.
    this.pageIndexInputView = new LabeledFieldView(locale, createLabeledInputNumber)
    ...
    this.pageIndexInputView.fieldView.bind('value').to(this, 'params', (params) => params?.index)
  ...
  _createBlockToggleInputs() {
    ...
    this.toggleBlockInputView = new LabeledFieldView(locale, createLabeledDropdown)
    ...
    this.toggleBlockInputView.bind('isEmpty').to(this, 'params', (params) => !params?.name)
    ...
    addListToDropdown(this.toggleBlockInputView.fieldView, nameDropdownDefinitions)

    // Action.
    const actionLabels = getToggleActionLabels(t)
    this.toggleActionInputView = new LabeledFieldView(locale, createLabeledDropdown)
    ...
    this.toggleActionInputView.bind('isEmpty').to(this, 'params', (params) => !params?.action)
    ...
    addListToDropdown(this.toggleActionInputView.fieldView, actionDropdownDefinitions)
  ...
  _createScenarioInputs() {
    ...
    // Scenario.
    const scenarioLabels = getComponentLabels('Scenario')
    this.scenarioScenarioInputView = new LabeledFieldView(locale, createLabeledDropdown)
    ...
    this.scenarioScenarioInputView.bind('isEmpty').to(this, 'params', (params) => !params?.id)
    ...
    addListToDropdown(this.scenarioScenarioInputView.fieldView, idDropdownDefinitions)
  ...
  _createFullscreenInputs() {
    ...
    this.fullscreenActionInputView = new LabeledFieldView(locale, createLabeledDropdown)
    ...
    this.fullscreenActionInputView.bind('isEmpty').to(this, 'params', (params) => !params?.action)
    const actionDropdownDefinitions = getDropdownDefinitions(actionLabels)
    actionDropdownDefinitions.map((definition) => {
      definition.model.bind('isOn').to(this, 'params', (value) => {
        return value?.action === definition.model._value
    ...
    addListToDropdown(this.fullscreenActionInputView.fieldView, actionDropdownDefinitions)

    const inputs = new FormGroupView(locale, {
      children: [this.fullscreenActionInputView],
    })
    inputs.bind('isVisible').to(this, 'type', (value) => value === 'fullscreen')
