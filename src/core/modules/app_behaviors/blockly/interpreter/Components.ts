    ...
    return {
      Components: {
        ...
        setProperty: (components, property, value) => {
          ...
          const { getComponent, setOverrides } = useModule("app_components") as AppComponentsModule;
        ...
        setScenario: (component) => {
          ...
          const { setActiveScenario } = useModule("app_components") as AppComponentsModule;
