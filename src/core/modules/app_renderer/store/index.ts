...
import type AssetsManagerModule from "../../assets_manager";
import type MediaPlayerModule from "../../media_player";
import type AppComponentsModule from "../../app_components";
...
export default defineStore("app-renderer", {
  ...
  getters: {
    ...
    fontAssets() {
      const { assets, getType } = useModule("assets_manager") as AssetsManagerModule;
  ...
  actions: {
    ...
    async loadFonts() {
      ...
      const { getFontName } = useModule("assets_manager") as AssetsManagerModule;
      const fonts = [];
    ...
    reset() {
      const { stop: stopMedia } = useModule("media_player") as MediaPlayerModule;
      const {
