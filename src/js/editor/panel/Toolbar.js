...
export default class Toolbar extends PARENT{
    ...
    constructor(configs) {
        ...
        _Array.each(this.configs.buttons, function(index, action){
        ...
        if(!_Var.isEmpty(this.configs.menuItems)){
            this.menu = new DropDownMenu();

            _Object.each(this.configs.menuItems, function(action, label){
