    ...
    */
    ...
    setupFields(){
        ...
        this.fields.name = new Field(
            new TextInput(),
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.name.label', 'Name')
            })
            .data('property', 'name')
        ...
        this.fields.hidden = new Field(
            ...
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.hidden.label', 'Hidden on start')
            })
        ...
        this.fields['background-image'] = new Field(
            new SelectInput(),
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.background-image.label', 'Background image')
            })
        ...
        this.fields['background-color'] = new Field(
            new ColorInput(),
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.background-color.label', 'Background color')
            })
        ...
        const border_fields_label = new Dom('<label/>', {'text': Locale.t('editor.configseditor.BlockTogglerForm.fields.border-fields.label', 'Border')})
        ...
        this.fields['border-color'] = new Field(
            new ColorInput(),
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.border-color.label', 'Border color')
            })
        ...
        this.fields['border-width'] = new Field(
            ...
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.border-width.label', 'Border width')
            })
        ...
        this.fields['border-radius'] = new Field(
            ...
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.border-radius.label', 'Border radius')
            })
        ...
        this.fields.x = new Field(
            ...
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.x.label', 'X')
            })
            .data('property', 'x')
            .appendTo(this.fields_wrapper);
        ...
        this.fields.y = new Field(
            ...
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.y.label', 'Y')
            })
            .data('property', 'y')
            .appendTo(this.fields_wrapper);
        ...
        this.fields.width = new Field(
            ...
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.width.label', 'Width')
            })
            .data('property', 'width')
            .appendTo(this.fields_wrapper);
        ...
        this.fields.height = new Field(
            ...
            {
                'label': Locale.t('editor.configseditor.BlockTogglerForm.fields.height.label', 'Height')
            })
