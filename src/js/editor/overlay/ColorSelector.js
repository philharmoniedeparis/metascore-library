...
export default class ColorSelector extends Overlay {
    ...
    constructor(configs) {
        ...
        this.onGradientMousemove = _Function.proxy(this.onGradientMousemove, this);
        this.onAlphaMousemove = _Function.proxy(this.onAlphaMousemove, this);
    ...
    setupUI() {
        ...
        this.gradient.canvas = new Dom('<canvas/>', {'width': '255', 'height': '255'})
            .addListener('click', _Function.proxy(this.onGradientClick, this))
            .addListener('mousedown', _Function.proxy(this.onGradientMousedown, this))
            .addListener('mouseup', _Function.proxy(this.onGradientMouseup, this))
        ...
        this.alpha.canvas = new Dom('<canvas/>', {'width': '20', 'height': '255'})
            .addListener('click', _Function.proxy(this.onAlphaClick, this))
            .addListener('mousedown', _Function.proxy(this.onAlphaMousedown, this))
            .addListener('mouseup', _Function.proxy(this.onAlphaMouseup, this))
            .appendTo(this.alpha);
        ...
        this.controls.r = new Dom('<input/>', {'type': 'number', 'min': '0', 'max': '255', 'name': 'r'})
            .addListener('input', _Function.proxy(this.onControlInput, this));
        ...
        this.controls.cancel = new Button({'label': 'Cancel'})
            .addClass('cancel')
            .addListener('click', _Function.proxy(this.onCancelClick, this))
            .appendTo(this.controls);
    ...
    updateValue(val, refillAlpha, updatePositions, updateInputs){
        ...
        if(!_Var.is(val, 'object')){
            val = _Color.parse(val);
        }
