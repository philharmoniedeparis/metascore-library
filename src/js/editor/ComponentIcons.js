...
import block__non_synched_icon from '../../img/editor/componenticons/block--non-synched.svg?svg-sprite';
...
export const blocktoggler = blocktoggler_icon;

export const block = {
    'synched': block__synched_icon,
    'non_synched': block__non_synched_icon
};

export const page = page_icon;
