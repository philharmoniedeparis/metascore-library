...
export default class Dom {
    ...
    constructor(...args) {
        ...
        if(arguments.length > 0){
            if(elements = Dom.elementsFromString(...args)){
                this.add(elements);
            ...
            else if(elements = Dom.selectElements(...args)){
                this.add(elements);
     ...
     */
    static camelReplaceFn = function(match, letter) {
     ...
     */
    static selectElement = function (selector, parent) {
        var element;
     ...
     */
    static selectElements = function (selector, parent) {
        var elements;
     ...
     */
    static elementsFromString = function(html){
        var wrapMap = {
     ...
     */
    static getElementWindow = function(element){
     ...
     */
    static hasClass = function(element, className){
     ...
     * @param {String} className The CSS class
     */
    static addClass = function(element, className){
     ...
     * @param {String} className The CSS class
     */
    static removeClass = function(element, className){
        var classNames = className.split(" "),
            i = 0, l = classNames.length;
     ...
     */
    static toggleClass = function(element, className, force){
        var classNames = className.split(" "),
            i = 0, l = classNames.length;
     ...
     */
    static addListener = function(element, type, callback, useCapture){
     ...
     * @return {HTMLElement} The element
     */
    static removeListener = function(element, type, callback, useCapture){
        if(useCapture === undefined){
            useCapture = ('type' in bubbleEvents) ? bubbleEvents[type] : false;
        }
     ...
     */
    static triggerEvent = function(element, type, data, bubbles, cancelable){
     ...
     */
    static text = function(element, html){
        if(html !== undefined){
            element.innerHTML = html;
        }
     ...
     */
    static val = function(element, value){
        var options, values;
        
        if(Dom.is(element, 'select[multiple]')){
            if(value){
                if(!_Var.is(value, 'array')){
                    value = [value];
                }
                
                options = Dom.selectElements('option', element);
                
                _Array.each(options, function(index, option){
                    Dom.prop(option, 'selected', _Array.inArray(Dom.val(option), value) > -1);
                });
            }
    ...
    static attr = function(element, name, value){
        if(_Var.is(name, 'object')){
            _Object.each(name, function(key, value){
     ...
     * @return {Mixed} The attribute's value, nothing is returned for 'special' attributes such as "class" or "text"
     */
    static prop = function(element, name, value){
        if(_Var.is(name, 'object')){
            _Object.each(name, function(key, value){
     ...
     */
    static css = function(element, name, value, inline){
        var camel, style;
     ...
     */
    static data = function(element, name, value){
     ...
     */
    static append = function(element, children){
        if (!_Var.is(children, 'array')) {
            children = [children];
        }

        _Array.each(children, function(index, child){
     ...
     */
    static before = function(element, siblings){
        if (!_Var.is(siblings, 'array')) {
            siblings = [siblings];
        }

        _Array.each(siblings, function(index, sibling){
     ...
     * @param {Mixed} siblings An array of elemets or a single element to insert
     */
    static after = function(element, siblings){
        if (!_Var.is(siblings, 'array')) {
            siblings = [siblings];
        }
     ...
     */
    static is = function(element, selector){
        var win;
     ...
     */
    static closest = function(element, selector){
        var document, win;
     ...
     */
    static offset = function(element){
        var left = 0,
            top = 0;
    ...
    each(callback, scope){
        ...
        _Array.each(this.elements, callback, scope);
    };
     ...
     */
    attr(name, value) {
        if(value !== undefined || _Var.is(name, 'object')){
            this.each(function(index, element) {
