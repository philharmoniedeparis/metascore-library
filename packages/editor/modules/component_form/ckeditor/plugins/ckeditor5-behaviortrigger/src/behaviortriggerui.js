...
export default class BehaviorTriggerUI extends Plugin {
  ...
  _createActionsView() {
    ...
    const removeBehaviorTriggerCommand = editor.commands.get('removeBehaviorTrigger')
  ...
  _createToolbarAddButton() {
    ...
    editor.ui.componentFactory.add('addBehaviorTrigger', (locale) => {
      ...
      button.bind('isOn').to(addBehaviorTriggerCommand, 'value', (value) => !!value)
  ...
  _addFormView() {
    ...
    this.formView.idInputView.fieldView.element.value =
      addBehaviorTriggerCommand.value || this._generateIdFromSelection(selection)
  }
   ...
   */
  _closeFormView() {
    const addBehaviorTriggerCommand = this.editor.commands.get('addBehaviorTrigger')
